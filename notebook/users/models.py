...
class User(AbstractUser):
    ...
    email = models.EmailField(unique=True, help_text='E-mail', verbose_name='E-mail')
    birthday = models.DateField(help_text='Дата рождения', verbose_name='Дата рождения')
    is_active = models.BooleanField(help_text='Статус', verbose_name='Статус', default=True)
